...
# # %%
# save_loc = 'E:\\OneDrive - TU Eindhoven\\Master thesis\\Tex\\Images\\Results\\Conductivity\\Nitrogen 2 + Argon 2\\'
# analyse_directory_conductivity(data_loc, voltages, pulse_lengths, save_loc=save_loc, show=True, align='start')

# # %%
# save_loc = 'E:\\OneDrive - TU Eindhoven\\Master thesis\\Tex\\Images\\Results\\Emission\\Nitrogen 2 + Argon 2\\total_intensity\\'
...
# # %%
# save_loc = 'E:\\OneDrive - TU Eindhoven\\Master thesis\\Tex\\Images\\Results\\Emission\\Nitrogen 2 + Argon 2\\total_intensity_p2\\'
# save_loc1 = f'{save_loc}Voltages\\'
# save_loc2 = f'{save_loc1}Individual\\'
# emission_ranges(data_loc, voltages, pulse_lengths, save_loc1=save_loc, save_loc2=save_loc1, save_loc3=save_loc2,
#                 wavelength_ranges=((270, 400), (654, 659), ((690, 775), (780, 860))),
#                 labels=(r'N$_{2}$', r'H$_{\alpha}$', 'Ar'),
#                 peaks=((316, 337, 357.5, 380), (763.5, 811.5, 850.5), (763.5,)))

# # %%
# save_loc = 'E:\\OneDrive - TU Eindhoven\\Master thesis\\Tex\\Images\\Results\\Emission\\Nitrogen 2 + Argon 2\\total_intensity_p\\'
# save_loc1 = f'{save_loc}Voltages\\'
# save_loc2 = f'{save_loc1}Individual\\'
...
# # %%
# save_loc = 'E:\\OneDrive - TU Eindhoven\\Master thesis\\Tex\\Images\\Results\\Emission\\Nitrogen 2 + Argon 2\\spectra\\'
