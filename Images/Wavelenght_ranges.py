...
analyzer_H2O2 = Analyzer.standard(rf'{drive_letter()}:\OneDrive - TU Eindhoven\Master thesis\Measurements\Calibration\H2O2 cuvette\data.hdf5', 'H2O2', 'H2O2 [mM]')
analyzer_NO3 = Analyzer.standard(rf'{drive_letter()}:\OneDrive - TU Eindhoven\Master thesis\Measurements\Calibration\NO3 cuvette\data.hdf5', 'NO3-', 'NO3- [mM]')
analyzer_NO2 = Analyzer.standard(rf'{drive_letter()}:\OneDrive - TU Eindhoven\Master thesis\Measurements\Calibration\NO2 cuvette\data.hdf5', 'NO2-', 'NO2- [mM]')
...
hno2 = np.loadtxt(r"E:\OneDrive - TU Eindhoven\Master thesis\Spectral_data\HNO2.txt", unpack=True)
no2 = np.loadtxt(r"E:\OneDrive - TU Eindhoven\Master thesis\Spectral_data\NO2-.txt", unpack=True)
...
plt.plot(no2[0], no2[1], label='NO2-')
plt.plot(hno2[0], hno2[1], label='HNO2')
plt.xlabel('Wavelength [nm]')
